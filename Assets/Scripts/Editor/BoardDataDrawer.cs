...
public class BoardDataDrawer : Editor {
    //Oyun düzeninin görülebileceði Editör tablosunun oluþturulmasý.
    private BoardData GameDataInstance => target as BoardData;
    private ReorderableList _dataList;
    public WordsGrid wordsGrid;
    ...
    //Harflerin yazýlabileceði satýr ve sütunlarýn oluþturulmasý.
    public void DrowColumnsInputFields() {
    ...
    private void InitializeReordableList(ref ReorderableList list, string propertyName, string listLabel) {
        _wordDatabase = FindAnyObjectByType<WordDatabase>();
        list = new ReorderableList(serializedObject, serializedObject.FindProperty(propertyName), true, true, true, true);

        SerializedProperty listProperty = serializedObject.FindProperty("SearchWords");

        listProperty.arraySize = _wordDatabase.wordCountCollide + _wordDatabase.wordCountAlone;
    ...
    private void ConvertToUpperButton() {
        //Kelime harflerinin büyük harfe çevirilmesini saðlayan fonksiyon.
    ...
    private void ClearBoardButton() {
        //Tabloyu temizlemeyi saðlayan buton.
    ...
    private void FillUpWithRandomLettersButton() {
        //Tabloyu rastgele harfler ile doldurulmasýný saðlayan fonksiyon.
