...
public static class GameEvents
{
    ...
    public static void EnableSquareSelectionMethod() { //Kare seçiminin saðlanmasý.
    ...
    public static void DisableSquareSelectionMethod() { //Kare seçiminin kapanmasý.
    ...
    public static void CheckSquareMethod(string letter, Vector3 squarePosition, int squareIndex) { //Girilen harflerin kontrolü.
    ...
    public static void ClearSelectionMethod() { //Seçimin temizlenmesi.
    ...
    public static void CorrectWordMethod(string word, List<int> squareIndexes) { //Seçilen harflerin kombinasyonunun doðru kelime olmasý halinde gerçekleþecek fonksiyon.
